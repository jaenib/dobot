...
class User(Base):
    ...
    setting: Mapped[Setting | None] = relationship("Setting", back_populates="user", uselist=False, cascade="all, delete-orphan")
...
class Task(Base):
    ...
    domain: Mapped[Domain | None] = relationship("Domain", back_populates="tasks")
    ...
    streak: Mapped[Streak | None] = relationship("Streak", back_populates="task", uselist=False, cascade="all, delete-orphan")
